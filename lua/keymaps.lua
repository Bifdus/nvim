...
wk.add({
  ...
  desc = "[c]ompare [w]indows",
  mode = "n",
  icon = { icon = "󰆊", color = "green" },
})
...
vim.keymap.set("n", "<leader>zd", "<cmd>Telekasten goto_today<CR>", { desc = "Telekasten Goto Today" })
vim.keymap.set("n", "<leader>zz", "<cmd>Telekasten follow_link<CR>", { desc = "Telekasten Follow Link" })
vim.keymap.set("n", "<leader>zn", "<cmd>Telekasten new_note<CR>", { desc = "Telekasten New Note" })
vim.keymap.set("n", "<leader>zc", "<cmd>Telekasten show_calendar<CR>", { desc = "Telekasten Calendar" })
